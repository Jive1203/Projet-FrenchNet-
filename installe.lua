...
local JEUX = {
  ...
  vehicule = {
    ...
    fichiers = {
      ...
      { "autopilote/console.lua",          "/autopilote/console.lua" },
      { "autopilote/routes.lua",           "/autopilote/routes.lua" },
    ...
    suite = {
      "cablage          -- verifier le cablage, piloter a la main",
      "console          -- calibration, itineraires, vol",
      "interface        -- reglages detailles du vehicule",
    },
  },

--[[----------------------------------------------------------------------------
  LANCEUR AUTOMATIQUE - SYSTEME EMBARQUE DOOMSDAY SHIP
  --------------------------------------------------------------------------
  A placer a la RACINE de l'ordinateur du systeme embarque (/startup.lua).
...
print("[LANCEUR] Demarrage du systeme embarque...")

...
local function champsSorties(axe, libelle)
  return {
    ...
    { cle = "sorties.axes." .. axe .. ".hysteresis", libelle = libelle .. " : hysteresis",
      type = "nombre", aide = "boite : gain minimal exige pour changer de rapport" },
    { cle = "sorties.axes." .. axe .. ".cyclesEntreRapports",
...
local SCHEMA = {
  ...
  { titre = "Amarrage", champs = {
    ...
    { cle = "carburant.amarrage.delaiMax", libelle = "Delai max de manoeuvre",
      type = "nombre" },
    { cle = "carburant.amarrage.tentatives", libelle = "Tentatives d'amarrage",
      type = "nombre", aide = "sans capteur de cap, un amarrage rate se rattrape en recommencant" },
    { cle = "carburant.amarrage.delaiImmobile", libelle = "Abandon si immobile",
      type = "nombre", aide = "s sans progres avant de recommencer la tentative" },
  ...
  { titre = "Journal", champs = {
    ...
    { cle = "journal.niveauFichier", libelle = "Niveau fichier", type = "choix",
      options = { "DEBUG", "INFO", "AVERT", "ERREUR" },
      aide = "INFO allege nettement le disque et le cycle" },
